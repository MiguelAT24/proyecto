...
export default async function handler(req, res) {
  if (req.method === 'GET') {
    ...
    try {
      ...
      const [personal] = await connection.query('SELECT * FROM personal');
      connection.end();
    ...
    try {
      ...
      const [result] = await connection.query(
        'INSERT INTO personal (nombre, apellido, correo, rol, telefono, direccion, ci, fech_nac, ciudad, pais) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)',
        [
          nombre,
          apellido,
          correo,
